...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    elif opt.custom == 'custom':
        compute_loss = ComputeLoss(model, opt.loss, opt.n, opt.gamma, opt.sigma)  # init loss class
...
def parse_opt(known=False):
    ...
    # parser.add_argument('--workers', type=int, default=0, help='max dataloader workers (per RANK in DDP mode)')         # num_worker 위에 다 안됨...
...
if __name__ == "__main__":
    opt = parse_opt()
    if opt.custom == 'plain':
        print("==============Plain Loss Chosen=============")
        print(opt.custom)
        from utils.loss import ComputeLoss
    elif opt.custom == 'custom':
        print("==============Custom Loss Chosen=============")
        print(opt.custom)
        from utils.loss_custom import ComputeLoss
    main(opt)
